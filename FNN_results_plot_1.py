...
while iteration < 9:  # Run for 5 iterations
    ...
    actual_tag = ["name","introduction","application","greeting","farewell","thanks","help","creator","health"] # Replace with the actual tag
